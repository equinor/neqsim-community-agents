# Compressor Anti-Surge Agent Tests

This folder documents how the Compressor Anti-Surge Agent is validated in the community repository.
...
- the declared required skill (`compressor-antisurge-recycle`)
