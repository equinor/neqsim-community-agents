...
`skills/subsea/neqsim-pipeline-survey-processing/tests`,
`skills/subsea/neqsim-bathymetry-profile-screening/tests`,
`skills/process/neqsim-pressure-drop-screening/tests`, and
