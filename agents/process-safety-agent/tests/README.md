# Process Safety Agent Tests

This folder documents how the Process Safety Agent is validated in the community repository.
...
- the declared required skills (`relief-load-screening`, `depressurization-screening`)
