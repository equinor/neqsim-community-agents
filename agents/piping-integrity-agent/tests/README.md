# Piping Integrity Agent Tests

This folder documents how the Piping Integrity Agent is validated in the community repository.
...
- the declared required skills (`line-velocity-check`, `pressure-drop-screening`, `pipe-wall-thickness-screening`, `flow-induced-vibration-screening`)
...
`skills/process/neqsim-pipe-wall-thickness-screening/tests`, and
`skills/process/neqsim-flow-induced-vibration-screening/tests`.
