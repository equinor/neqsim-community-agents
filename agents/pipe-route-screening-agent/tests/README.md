# Pipe Route Screening Agent Tests

This folder documents how the Pipe Route Screening Agent is validated in the community repository.
...
- the declared required skills (`pipe-route-profile`, `pressure-drop-screening`, `line-velocity-check`, `hydrate-margin-check`)
